...
const DashboardSidebar: React.FC<{
  ...
  return (
    <div className="bg-base-200 w-64 h-full min-h-screen flex justify-center border border-r-primary">
      <nav className="flex flex-col justify-between w-full">
        <section>
          <div className="bg-base-300 w-[100%] p-6 text-center">
            <div className="bg-base-200 p-4 rounded-lg">
              <h1 className="font-bold text-lg">Content Spark ✨</h1>
            </div>
          </div>
